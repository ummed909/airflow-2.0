...
from include.first_etl.python_function import _check_api, _get_the_data, _store_data, _get_raw_data_and_save_in_temp_file, _run_bash_function_to_process_raw_data, load_data_to_postgres, load_data_to_aws
...
with DAG(
    ...
    with TaskGroup("Load") as Load:
        ...
        load_data_to_aws = PythonOperator(
